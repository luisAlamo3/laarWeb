    ...
    <footer className="py-10 px-6 md:px-12 text-center bg-[#0b0f20]">
      <div className="container mx-auto">
        <div className="h-16 w-16 mx-auto rounded-full bg-gray-900 flex items-center justify-center mb-4">
          <img src="https://placehold.co/64x64/000000/FFFFFF?text=HP" alt="Logo de la empresa" className="rounded-full" />
        </div>
        <h3 className="text-xl font-semibold text-gray-200 mb-2">Servicios Técnicos Profesionales</h3>
        ...
        <p className="text-gray-500 text-xs">&copy; 2024 Servicios Técnicos Profesionales. Todos los derechos reservados.</p>
      </div>
    </footer>
  );
}
