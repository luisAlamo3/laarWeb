    ...
    <section className="hero-bg text-center py-20 md:py-32 rounded-b-3xl" style={{background: "linear-gradient(135deg, #2b0c5f 0%, #150f3b 100%)"}}>
      <div className="container mx-auto px-4">
        <div className="h-20 w-20 mx-auto rounded-full bg-gray-900 flex items-center justify-center mb-6">
          <img src="https://placehold.co/80x80/000000/FFFFFF?text=HP" alt="Logo de la empresa" className="rounded-full" />
        </div>
        <h1 className="text-4xl md:text-6xl font-bold text-gray-200 mb-2">Servicios Técnicos <span className="text-purple-400">Profesionales</span></h1>
        <p className="text-lg md:text-xl text-gray-400 mb-6">Soluciones integrales en tecnología para empresas y particulares.</p>
        <p className="text-md md:text-lg text-gray-400 mb-10">Mantenimiento, instalación y soporte técnico especializado.</p>
